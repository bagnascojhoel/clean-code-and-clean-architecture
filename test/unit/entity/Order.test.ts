...
test('Should create when all parameters are valid', () => {
    const item1 = new OrderItem(123, new Decimal(12.5), 1);
    const item2 = new OrderItem(456, new Decimal(15), 23);
...
test('Should have price 300 when there is a total of 100 in items and freight is 200', () => {
    const item1 = new OrderItem(123, new Decimal(25), 2);
    const item2 = new OrderItem(456, new Decimal(50), 1);
